...
if (isset($_SERVER['REMOTE_USER'])) //Если есть прозрачно аутентифицированный пользователь. И в серверной переменной хранится его логин
{
    ...
    {
        if (in_array($Login, $ADMINS)) //Пользователь является администратором справочника
        {
            $Access = true;
        } else //Пользователь НЕ является администратором справочника
            $Access = false;
