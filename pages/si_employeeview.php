...
if(!$HIDE_CITY_PHONE_FIELD)
	echo "<div class=\"phone\"><h6>".$L->l('city_phone').":</h6> <".$tag.">".Staff::makeCityPhone($ldap->getValue($dn, $LDAP_CITY_PHONE_FIELD),$GLOBALS['ENABLE_CALL_VIA_IP'])."</".$tag."></div>";

echo "<div class=\"otherphone\"><h6>".$L->l('intrenal_phone').":</h6> <".$tag.">".Staff::makeInternalPhone($ldap->getValue($dn, $LDAP_INTERNAL_PHONE_FIELD),$GLOBALS['ENABLE_CALL_VIA_IP'])."</".$tag."></div>";

if(!$HIDE_CELL_PHONE_FIELD)
	echo "<div class=\"otherphone\"><h6>".$L->l('cell_phone').":</h6> ".Staff::makeCellPhone($ldap->getValue($dn, $LDAP_CELL_PHONE_FIELD),$GLOBALS['ENABLE_CALL_VIA_IP'])."</div>";

if($HomePhone=$ldap->getValue($dn, $LDAP_HOMEPHONE_FIELD))
	echo "<div class=\"otherphone\"><h6>".$L->l('home_phone').":</h6> ".Staff::makeHomePhone($HomePhone,$GLOBALS['ENABLE_CALL_VIA_IP'])."</div>";
